...
#     '''
#     '''
#     A simple code to validate the correctness
#     of the above codes.
# '''
#     model_name = "gpt2"
#     tokenizer = GPT2Tokenizer.from_pretrained(model_name)

#     tokenizer_root = os.path.join("model", "pretrained", "tokenizer")
#     if not os.path.exists(tokenizer_root):
#         os.makedirs(tokenizer_root)
...
#     vocab_file_online = PRETRAINED_VOCAB_FILES_MAP["vocab_file"][model_name]
#     merges_file_online = PRETRAINED_VOCAB_FILES_MAP["merges_file"][model_name]

#     vocab_file = os.path.join(tokenizer_root, "vocab_file.json")
#     merges_file = os.path.join(tokenizer_root, "merges.txt")

#     if not os.path.exists(vocab_file):
#         wget.download(vocab_file_online, vocab_file)
#     if not os.path.exists(merges_file):
#         wget.download(merges_file_online, merges_file)
...
#                                               num_users,
#                                               num_items)
#     print("-----Show the encoding process:-----")
#     text = "Hello, user_1! Have you seen item_2?"
#     tokenized_text = tokenizer.tokenize(text)
#     input_ids = tokenizer.convert_tokens_to_ids(tokenized_text)
#     input_ids_encode = tokenizer.encode(text)

#     print(text)
#     print(tokenized_text)
#     print(input_ids)
#     print(input_ids_encode)

#     print("\n-----Show the decoding process:-----")
#     dec_tokens = tokenizer.convert_ids_to_tokens(input_ids)
#     dec_text = tokenizer.convert_tokens_to_string(dec_tokens)
#     dec_text_decode = tokenizer.decode(input_ids_encode)
#     print(input_ids)
#     print(dec_tokens)
#     print(dec_text)
#     print(dec_text_decode)

    tokenizer = DynamicSPTokenizer("/data/sjc4fq/tokenizers/Llama-3.2-1B", num_users=10, num_items=10, memory=UserItemMemory())